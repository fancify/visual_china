...
const ROUTE_DEFINITIONS = [
  ...
  },
  {
    ...
    anchors: [
      ...
      { name: "长安", note: "子午道北口，关中东段核心。", lat: 34.27, lon: 108.95 }
    ]
  },
  {
    id: "tangluo-road",
    ...
    anchors: [
      ...
      { name: "周至 骆谷北口", note: "长安西南周至县入山口", lat: 33.97, lon: 108.3 },
  ...
  },
  {
    ...
    labelIndex: 3,
    anchors: [
      { name: "长安", note: "子午道关中起点，长安城南门外", lat: 34.27, lon: 108.95 },
      { name: "长安 子午谷北口", note: "长安城南子午峪", lat: 33.97, lon: 108.85 },
  ...
  },
  {
    ...
    labelIndex: 2,
    anchors: [
      { name: "长安", note: "唐代长安起点", lat: 34.27, lon: 108.95 },
  ...
  },
  {
    ...
    anchors: [
      ...
      { name: "导江", note: "岷江出山口与川西转运节点（唐 蜀州导江县，今都江堰）；承接成都北上西南茶路。", lat: 30.99, lon: 103.65 },
      { name: "矩州", note: "黔中高原交通中枢，川黔商路在此会聚（唐 矩州，今贵阳）。", lat: 26.65, lon: 106.63 },
      { name: "都匀", note: "黔南分路节点，茶马古道在此折向桂北。", lat: 26.26, lon: 107.52 },
      { name: "桂州", note: "桂北漓江商埠，西南茶货转入广西水陆贸易（唐 桂州，今桂林）。", lat: 25.27, lon: 110.29 }
    ]
  },
  {
    id: "xiang-qian-route",
    ...
    anchors: [
      ...
      { name: "矩州", note: "黔中首府，湘黔古道西端总汇（唐 矩州，今贵阳）。", lat: 26.65, lon: 106.63 }
    ]
  }
];
