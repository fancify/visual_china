# AGENTS.md — 山河中国项目本地约定

> 项目本地协作约定（global AGENTS.md 已覆盖通用规则）。新会话自动读到。
...
- **写代码** — Codex 主导；S2 commit 起类型债已大幅清理，新代码必须有 TS 类型
...
见 [todo.md](./todo.md) 和 [memory/project_refactor_plan_v1](.Codex/projects/-Users-chen-Documents-GitHub-visual-china/memory/project_refactor_plan_v1.md)。
