...
// 把每个残简的预期地理位置投影到当前 world。Phase 2 全国扩张前 fragments 用
// 硬编码的 sliceWorld (180×240) 坐标，扩张到 1711×1186 后这些坐标会漂到新疆。
// 改成 lat/lon → 投影，让 fragments 永远落在 zone 描述的真实位置。
function geoFragment(
  lat: number,
  lon: number,
  meta: Omit<KnowledgeFragment, "position">
): KnowledgeFragment {
