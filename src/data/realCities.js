...
export const realQinlingCities = [
  // 京城（capital）
  { id: "xian", name: "西安", lat: 34.27, lon: 108.95, tier: "capital", hint: "古长安，关中盆地的核心，汉/唐都城" },
  { id: "chengdu", name: "成都", lat: 30.66, lon: 104.07, tier: "capital", hint: "成都平原核心，蜀汉都城，金牛道终点" },

  // 州府（prefecture）
  { id: "baoji", name: "宝鸡", lat: 34.36, lon: 107.24, tier: "prefecture", hint: "陈仓道入秦岭起点，关中西门户" },
  { id: "hanzhong", name: "汉中", lat: 33.07, lon: 107.03, tier: "prefecture", hint: "汉中盆地核心，秦巴间咽喉，多条蜀道交汇" },
  { id: "guangyuan", name: "广元", lat: 32.43, lon: 105.84, tier: "prefecture", hint: "金牛道入蜀第一城，剑门关北口" },
  { id: "tianshui", name: "天水", lat: 34.58, lon: 105.72, tier: "prefecture", hint: "祁山道终点，诸葛亮六出祁山的目标" },
  { id: "mianyang", name: "绵阳", lat: 31.47, lon: 104.74, tier: "prefecture", hint: "金牛道蜀地段重要节点" },
  { id: "bazhong", name: "巴中", lat: 31.85, lon: 106.77, tier: "prefecture", hint: "米仓道南端" },
  { id: "deyang", name: "德阳", lat: 31.13, lon: 104.40, tier: "prefecture", hint: "金牛道入成都前最后一站" },
  { id: "dujiangyan", name: "都江堰", lat: 31.00, lon: 103.62, tier: "prefecture", hint: "战国李冰所修水利工程，成都平原灌溉源头" },
