...
export const MAP_NORTH: MapDirectionVector = Object.freeze({ x: 0, z: -1 });

/** 南方在世界中的方向。 */
export const MAP_SOUTH: MapDirectionVector = Object.freeze({ x: 0, z: 1 });

/** 东方在世界中的方向（与屏幕 right 对齐）。 */
export const MAP_EAST: MapDirectionVector = Object.freeze({ x: 1, z: 0 });

/** 西方在世界中的方向。 */
export const MAP_WEST: MapDirectionVector = Object.freeze({ x: -1, z: 0 });

export const MAP_ORIENTATION_CONTRACT: MapOrientationContract = Object.freeze({
  northAxis: "-z",
  eastAxis: "+x",
  description:
