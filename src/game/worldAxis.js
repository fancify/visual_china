...
export const ENGINE_CAMERA_FORWARD_AXIS = Object.freeze({ x: 0, y: 0, z: -1 });

/** Three.js 默认相机 right axis（屏幕右）= +X。 */
export const ENGINE_CAMERA_RIGHT_AXIS = Object.freeze({ x: 1, y: 0, z: 0 });

/** Three.js 默认相机 up axis（屏幕上）= +Y。 */
export const ENGINE_CAMERA_UP_AXIS = Object.freeze({ x: 0, y: 1, z: 0 });

export const ENGINE_AXIS_CONTRACT = Object.freeze({
  description:
